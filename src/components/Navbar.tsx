...
function Navbar({ active, setActive }: { active: string; setActive: (val: string) => void }) {
  ...
  return (
    <div className="fixed top-3 left-4 right-4 py-3 mx-auto px-4 h-15 bg-black rounded-xl z-50">
        ...
        <a href="#about" onClick={() => setActive("about")} className={`flex items-center gap-3 cursor-pointer rounded-sm w-80 self-center px-4 py-2 border border-[#DAED6D] ${active === "about" ? "bg-[#F5E901] text-black" : "hover:bg-[#DAED6D] hover:text-black"}`}>
          <div className="rounded-full h-3 w-3 bg-neutral-700"></div>
          <div className="font-semibold">About</div>
        </a>
        <a href="#skills" onClick={() => setActive("skills")} className={`flex items-center gap-3 cursor-pointer rounded-sm w-80 self-center px-4 py-2 border border-[#DAED6D] ${active === "skills" ? "bg-[#F5E901] text-black" : "hover:bg-[#DAED6D] hover:text-black"}`}>
          <div className="rounded-full h-3 w-3 bg-neutral-700"></div>
          <div className="font-semibold">Skills</div>
        </a>
        <a href="#projects" onClick={() => setActive("projects")} className={`flex items-center gap-3 cursor-pointer rounded-sm w-80 self-center px-4 py-2 border border-[#DAED6D] ${active === "projects" ? "bg-[#F5E901] text-black" : "hover:bg-[#DAED6D] hover:text-black"}`}>
          <div className="rounded-full h-3 w-3 bg-neutral-700"></div>
          <div className="font-semibold">Projects</div>
        </a>
        <a href="#experience" onClick={() => setActive("experience")} className={`flex items-center gap-3 cursor-pointer rounded-sm w-80 self-center px-4 py-2 border border-[#DAED6D] ${active === "experience" ? "bg-[#F5E901] text-black" : "hover:bg-[#DAED6D] hover:text-black"}`}>
          <div className="rounded-full h-3 w-3 bg-neutral-700"></div>
          <div className="font-semibold">Experience</div>
        </a>
        <a href="#contact" onClick={() => setActive("contact")} className={`flex items-center gap-3 cursor-pointer rounded-sm px-4 w-80 self-center py-2 border border-[#DAED6D] ${active === "contact" ? "bg-[#F5E901] text-black" : "hover:bg-[#DAED6D] hover:text-black"}`}>
          <div className="rounded-full h-3 w-3 bg-neutral-700"></div>
          <div className="font-semibold">Contact</div>
        </a>
        </div>
