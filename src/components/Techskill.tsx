...
function Techskill() {
  return (
    <div className="pt-5 px-4">
      <div className="mt-35 text-5xl max-sm:text-3xl max-md:text-4xl font-bold tracking-tight leading-normal text-center bg-gradient-to-b from-[#DDFE9C]/90 to-[#DDFE9C] bg-clip-text text-transparent dark:text-black">
        Skills
      </div>
      <p className="font-medium mx-auto max-w-3xl text-center text-gray-300 dark:text-neutral-600 mb-8 text-sm sm:text-lg leading-relaxed">
      ...
      <div className="hidden sm:flex mx-auto max-w-3xl border border-[#DDFE9C] dark:border-black rounded-md px-5 py-2.5 gap-4 mb-20">
        ...
        <div className="text-white dark:text-black"><span className="font-bold">Suggestion:</span> Hover over any skill to see my proficiency level.</div>
      </div>

      <div className="space-y-15 pt-4">
      <div className="relative border border-gray-500 rounded-xl p-8 pt-10">
        <span className="absolute -top-4 left-6 bg-black dark:bg-gray-200 px-3 text-lg font-semibold text-gray-200 dark:text-neutral-700">Programming Languages</span>
      ...
      <div className="relative border border-gray-500 rounded-xl p-8 pt-10">
        <span className="absolute -top-4 left-6 bg-black dark:bg-gray-200 px-3 text-lg font-semibold text-gray-200 dark:text-neutral-700">Development</span>
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-10 sm:gap-15 justify-center">
      ...
      <div className="relative border border-gray-500 rounded-xl p-8 pt-10">
        <span className="absolute -top-4 left-6 bg-black dark:bg-gray-200 px-3 text-lg font-semibold text-gray-200 dark:text-neutral-700">Databases</span>
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-10 sm:gap-15 justify-center">
      ...
      <div className="relative border border-gray-500 rounded-xl p-8 pt-10">
        <span className="absolute -top-4 left-6 bg-black dark:bg-gray-200 px-3 text-lg font-semibold text-gray-200 dark:text-neutral-700">Frameworks</span>
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-10 sm:gap-15 justify-center">
      ...
      <div className="relative border border-gray-500 rounded-xl p-8 pt-10">
        <span className="absolute -top-4 left-6 bg-black dark:bg-gray-200 px-3 text-lg font-semibold text-gray-200 dark:text-neutral-700">Libraries</span>
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-10 sm:gap-15 justify-center">
      ...
      <div className="relative border border-gray-500 rounded-xl p-8 pt-10">
        <span className="absolute -top-4 left-6 bg-black dark:bg-gray-200 px-3 text-lg font-semibold text-gray-200 dark:text-neutral-700">Tools</span>
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-10 sm:gap-15 justify-center">
      ...
      <div className="relative border border-gray-500 rounded-xl p-8 pt-10">
        <span className="absolute -top-4 left-6 bg-black dark:bg-gray-200 px-3 text-lg font-semibold text-gray-200 dark:text-neutral-700">Protocols</span>
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-10 sm:gap-15 justify-center">
...
function SkillBox({ img, label, maxValue, withBg }: { img: string; label: string; maxValue: number; withBg?: boolean }) {
  ...
  return (
    <motion.div onMouseEnter={startProgress} onMouseLeave={() => setHovered(false)} className="relative flex items-center justify-center p-4 bg-gray-700 dark:bg-gray-200 rounded-lg shadow-md cursor-pointer w-32 h-32 overflow-hidden transition-all duration-300 hover:shadow-xl">
      ...
      {!hovered ? (
        <motion.div className="flex flex-col items-center justify-center text-center">
          ...
          <p className="text-white dark:text-black text-sm font-semibold mt-2">{label}</p>
        </motion.div>
      ) : (
