        ...
        <div className="w-full max-w-[565px] h-auto sm:w-[565px] sm:h-[400px] bg-black rounded-lg border-3 border-gray-700 hover:border-[#DDFE9C]/80 group">
          ...
          <div className="flex justify-between px-4 py-2">
            ...
            <div className="flex gap-3">
              <a onClick={() => new Audio('/switchtab.mp3').play()} href={'https://github.com/ashishxjhaa/Project-Funding'} target="_blank" rel="noopener noreferrer" className="rounded-sm bg-[#262626] hover:bg-[#DDFE9C] hover:text-black px-3 py-1.5 cursor-pointer">
              ...
              <a onClick={() => new Audio('/switchtab.mp3').play()} href={'https://projectfunding.vercel.app'} target="_blank" rel="noopener noreferrer" className="rounded-sm bg-[#262626] hover:bg-[#DDFE9C] hover:text-black px-3 py-1.5 cursor-pointer">
      ...
      <div className="flex">
        <div className="w-full max-w-[565px] h-auto sm:w-[565px] sm:h-[400px] bg-black rounded-lg border-3 border-gray-700 hover:border-[#DDFE9C]/80 group">
          ...
          <div className="flex justify-between px-4 py-2">
            ...
            <div className="flex gap-3">
              <a onClick={() => new Audio('/switchtab.mp3').play()} href={'https://github.com/ashishxjhaa/Report-Piracy'} target="_blank" rel="noopener noreferrer" className="rounded-sm bg-[#262626] hover:bg-[#DDFE9C] hover:text-black px-3 py-1.5 cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-code-icon lucide-code"><path d="m16 18 6-6-6-6"/><path d="m8 6-6 6 6 6"/></svg>
              </a>
              <a onClick={() => new Audio('/switchtab.mp3').play()} href={'https://reportpiracy.vercel.app'} target="_blank" rel="noopener noreferrer" className="rounded-sm bg-[#262626] hover:bg-[#DDFE9C] hover:text-black px-3 py-1.5 cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-arrow-up-right-icon lucide-arrow-up-right"><path d="M7 7h10v10"/><path d="M7 17 17 7"/></svg>
              </a>
            </div>
          </div>
