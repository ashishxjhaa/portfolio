...
function About() {
  return (
    ...
    <div className="max-w-85">Welcome to my Portfolio! Im always learning, improving, and open for exciting opportunities where I can grow and add value.</div>
    <div className="my-4 flex items-center justify-center gap-2 cursor-pointer border border-gray-600 rounded-sm w-fit h-fit px-3 py-1.5">
      ...
      <div>
        <div className="relative h-70 w-70 mr-30 mt-15 hover:scale-110 hover:-translate-y-2 transition-transform duration-300 cursor-pointer">
          <div className="absolute -inset-1 bg-gradient-to-r from-[#FF8162] to-[#FEB57F] rounded-full blur-sm opacity-75"></div>
            <Image src="/logo.jpg" alt="About" width={100} height={100} className="rounded-full relative h-70 w-70 z-10" />
          </div>
        <Image src='/react.svg' className="h-10 w-10" width={100} height={100} alt="About" />
        <Image src='/typescript.svg' className="h-10 w-10" width={100} height={100} alt="About" />
        <Image src='/next-js.svg' className="h-10 w-10 bg-white px-0.5" width={100} height={100} alt="About" />
        <Image src='/javascript.svg' className="h-10 w-10" width={100} height={100} alt="About" />
      </div>
    </div>
  )
}
