    ...
    <>
      ...
      <div className="flex">
        <div className="pt-20 mx-auto">
          <div>
            <div className="flex items-center px-4 font-bold text-2xl sm:text-4xl gap-5 tracking-wide dark:text-slate-300 text-neutral-700">
              {`Hi, I'm`} 
            ...
            <div className="px-4 pt-2 flex items-center font-medium text-2xl sm:text-3xl gap-2 tracking-wide dark:text-slate-300 text-neutral-700">
              {`I'm a`} 
      ...
      <div className="px-10 pt-10 max-w-2xl mx-auto">
        <h2 className="text-lg sm:text-xl dark:text-white text-black font-semibold">About</h2>
        <p className="text-md dark:text-white text-black opacity-75 font-sans">
          {`Hello, I'm a Full Stack Web Developer. Feel free to explore my portfolio and reach out - I'd love to connect!`}
        </p>
      </div>
    </>
  )
