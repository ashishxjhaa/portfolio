  ...
  return (
    ...
    <div className="flex">
      <div className="pt-20 mx-auto">
        ...
        <div className="pt-5 px-4 text-sm max-w-sm md:max-w-lg lg:max-w-xl dark:text-white text-black opacity-85">I build web applications that look good, feel fast, and work flawlessly across devices.</div>
