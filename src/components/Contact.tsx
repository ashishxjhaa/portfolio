...
function Contact() {
  ...
  return (
    <div className="mx-10 py-20">
      ...
      <div className="group relative flex h-full w-full flex-col items-center justify-center p-6 bg-white/60 dark:bg-gray-800/60 backdrop-blur-lg rounded-2xl border border-gray-200/50 dark:border-white/10 shadow-lg text-gray-800 dark:text-white cursor-pointer">
      <div className="absolute top-4 right-4 z-10">
        <button aria-label="Copy Phone to clipboard" className="p-2 rounded-full text-gray-500 dark:text-gray-400 hover:bg-gray-200/80 dark:hover:bg-gray-700/80 transition-colors cursor-pointer">
          <div>
      ...
      <a href="tel:+919951077641" className="text-sm text-gray-600 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-300 transition-colors break-words">+91 8294430359</a>
      </div>

      <div className="group relative flex h-full w-full flex-col items-center justify-center p-6 bg-white/60 dark:bg-gray-800/60 backdrop-blur-lg rounded-2xl border border-gray-200/50 dark:border-white/10 shadow-lg text-gray-800 dark:text-white cursor-pointer">
      <div className="absolute top-4 right-4 z-10">
        <button aria-label="Copy Email to clipboard" className="p-2 rounded-full text-gray-500 dark:text-gray-400 hover:bg-gray-200/80 dark:hover:bg-gray-700/80 transition-colors cursor-pointer">
          <div>
            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="remixicon w-5 h-5"><path d="M6.9998 6V3C6.9998 2.44772 7.44752 2 7.9998 2H19.9998C20.5521 2 20.9998 2.44772 20.9998 3V17C20.9998 17.5523 20.5521 18 19.9998 18H16.9998V20.9991C16.9998 21.5519 16.5499 22 15.993 22H4.00666C3.45059 22 3 21.5554 3 20.9991L3.0026 7.00087C3.0027 6.44811 3.45264 6 4.00942 6H6.9998ZM5.00242 8L5.00019 20H14.9998V8H5.00242ZM8.9998 6H16.9998V16H18.9998V4H8.9998V6Z"></path></svg>
          </div>
        </button>
      ...
      <a href="tel:+919951077641" className="text-sm text-gray-600 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-300 transition-colors break-words">ashishxyzjha@gmail.com</a>
      </div>

      <div className="group relative flex h-full w-full flex-col items-center justify-center p-6 bg-white/60 dark:bg-gray-800/60 backdrop-blur-lg rounded-2xl border border-gray-200/50 dark:border-white/10 shadow-lg text-gray-800 dark:text-white cursor-pointer">
      <div className="absolute top-4 right-4 z-10">
        <button aria-label="Copy Twitter to clipboard" className="p-2 rounded-full text-gray-500 dark:text-gray-400 hover:bg-gray-200/80 dark:hover:bg-gray-700/80 transition-colors cursor-pointer">
          <div>
            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="remixicon w-5 h-5"><path d="M6.9998 6V3C6.9998 2.44772 7.44752 2 7.9998 2H19.9998C20.5521 2 20.9998 2.44772 20.9998 3V17C20.9998 17.5523 20.5521 18 19.9998 18H16.9998V20.9991C16.9998 21.5519 16.5499 22 15.993 22H4.00666C3.45059 22 3 21.5554 3 20.9991L3.0026 7.00087C3.0027 6.44811 3.45264 6 4.00942 6H6.9998ZM5.00242 8L5.00019 20H14.9998V8H5.00242ZM8.9998 6H16.9998V16H18.9998V4H8.9998V6Z"></path></svg>
          </div>
        </button>
      ...
      <a href="tel:+919951077641" className="text-sm text-gray-600 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-300 transition-colors break-words">ashishxjha</a>
      </div>
