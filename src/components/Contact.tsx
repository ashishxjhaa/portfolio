  ...
  return (
    <div className="mx-10 py-20">
      <div className="text-center">
        <div className="inline-block border-b-4 dark:border-[#DDFE9C] border-black text-5xl max-sm:text-3xl max-md:text-4xl font-bold tracking-tight leading-normal bg-gradient-to-b from-[#DDFE9C]/90 to-[#DDFE9C] bg-clip-text dark:text-transparent text-black">
          Get In Touch
        </div>
      ...
      <h3 className="text-lg font-semibold mb-1 dark:text-white text-black">Github</h3>
      <a href="https://github.com/ashishxjhaa" target="_blank" className="text-sm dark:text-gray-300 text-black/80 dark:hover:text-blue-300 hover:text-black transition-colors break-words">ashishxjhaa</a>
      </motion.div>
