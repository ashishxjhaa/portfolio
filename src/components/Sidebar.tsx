  ...
  return (
    <div className="w-fit my-4 bg-black py-4 rounded-sm h-fit max-h-[65vh] overflow-auto">
      <div className="flex flex-col gap-3 mx-3">
        ...
        <div onClick={() => setActive("skill")} className={`flex items-center gap-3 cursor-pointer rounded-sm px-4 pr-18 py-2 ${active === "techskill" ? "bg-[#F5E901] text-black" : "hover:bg-[#DAED6D] hover:text-black"}`}>
          <div className="rounded-full h-3 w-3 bg-neutral-700"></div>
